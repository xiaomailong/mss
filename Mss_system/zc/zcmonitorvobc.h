#ifndef ZCMONITORVOBC_H
#define ZCMONITORVOBC_H
...
class ZCMonitorVOBC : public QWidget
{
    Q_OBJECT

public:
    explicit ZCMonitorVOBC(QWidget *parent = 0,ZCReadData *readData =NULL);
    ~ZCMonitorVOBC();
signals:
