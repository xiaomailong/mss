...
uint32_t cb_crc32_ieee8023(uint8_t * data, uint32_t size)
{
	...
	/*- 计算CRC */
	crc = calculate_CRC32((const uint8_t*)data, size, IEEE8023_CRC32_TABLE, 0xFFFFFFFF, 0xFFFFFFFF);
...
uint32_t cb_crc32_Castagnoli(uint8_t * data, uint32_t size)
{
	/*- 初始化 */
    uint32_t crc = 0U;
    crc = calculate_CRC32((const uint8_t*)data, size, Castagnoli_CRC32_TABLE, 0xFFFFFFFF, 0xFFFFFFFF);
