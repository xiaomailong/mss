#-------------------------------------------------
#
# Project created by QtCreator 2017-02-20T15:18:40
#
#-------------------------------------------------
...
SOURCES += tst_ciprocess.cpp
DEFINES += SRCDIR=\\\"$$PWD/\\\"
MSS_SYSTEM_DIR = $$PWD/../../../Mss_system

HEADERS += $$MSS_SYSTEM_DIR/common/mssdatadefine.h \
    ...
    $$MSS_SYSTEM_DIR/ci/service/ciservice.h \
    $$MSS_SYSTEM_DIR/common/ci_data.cpp \
    $$MSS_SYSTEM_DIR/common/ci_data.h

SOURCES += $$MSS_SYSTEM_DIR/common/mss_transfer_data.cpp \
    $$MSS_SYSTEM_DIR/utils/b2v/src/b2v.cpp \
    $$MSS_SYSTEM_DIR/ci/service/ciservice.cpp


INCLUDEPATH += $$MSS_SYSTEM_DIR/ci/service \
