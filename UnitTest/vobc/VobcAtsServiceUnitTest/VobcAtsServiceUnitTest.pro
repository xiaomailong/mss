#-------------------------------------------------
#
# Project created by QtCreator 2017-02-27T14:46:24
#
#-------------------------------------------------
...
SOURCES += tst_vobcatsserviceut.cpp
DEFINES += SRCDIR=\\\"$$PWD/\\\"

SOURCES += $$MSS_SYSTEM_DIR/vobc/service/src/vobcatsservice.cpp \
    $$MSS_SYSTEM_DIR/common/mss_transfer_data.cpp \
    $$MSS_SYSTEM_DIR/utils/b2v/src/b2v.cpp

HEADERS += \
    $$MSS_SYSTEM_DIR/vobc/service/inc/vobcatsservice.h
